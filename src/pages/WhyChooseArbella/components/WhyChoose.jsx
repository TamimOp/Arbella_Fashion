...
const WhyChoose = () => {
  return (
    <section className="relative bg-[#F6FAFC] py-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1300px] mx-auto px-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="mt-2 text-[#4B4B4B] text-[18px] leading-[28px] max-w-[760px] mx-auto">
        ...
        <div className="flex justify-between items-end mb-16">
          <div>
            <h3 className='font-["Playfair_Display"] text-[36px] font-normal leading-[46px] text-[#2C2C2C]'>
              Maximum Value, <br />
        ...
        <div className="flex items-center gap-20">
          {/* Left Image */}
          <div className="w-[610px] h-[553.34px] flex-shrink-0">
            <img
          ...
          {/* Right Text */}
          <div className="flex flex-col justify-center gap-16 mt-6">
            {/* Item 1 */}
            <div className="flex items-center gap-6">
              <span className="text-[#FFA273] text-[36px] font-bold leading-[46px] font-sans flex items-center">
                01
              </span>
              <div>
                <h4 className="text-[#2C2C2C] text-[18px] font-semibold leading-[28px]">
                  Direct Manufacturer
                </h4>
                <p className="text-[#4B4B4B] text-[16px] leading-[26px] max-w-[400px]">
